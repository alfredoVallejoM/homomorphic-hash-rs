...
fn format_tensor_fingerprint(topology: &[[u64; 4]]) -> String {
    if topology.is_empty() { return "EMPTY".to_string(); }
    ...
    format!("Head:[{:08X}...] Tail:[{:08X}...]", first_node[0] >> 32, last_node[3] >> 32)
}
...
fn run_invariance_test(test_name: &str, target_smiles: &[&str], permutations: usize) -> bool {
    ...
    for smiles in target_smiles {
        ...
        let mut expected_fp = String::new();
...
fn main() {
    ...
    total_tests += 1; if d1_l1 { passed_tests += 1; }
    ...
    total_tests += 1; if d1_l2 { passed_tests += 1; }
    ...
    total_tests += 1; if d1_l3 { passed_tests += 1; }
    ...
    total_tests += 1; if d2_l1 { passed_tests += 1; }
    ...
    total_tests += 1; if d2_l2 { passed_tests += 1; }
    ...
    total_tests += 1; if d2_l3 { passed_tests += 1; }

    println!("\n======================================================================");
    if passed_tests == total_tests {
        println!("🏆 ALL DIAGNOSTICS PASSED! ({}/{})", passed_tests, total_tests);
